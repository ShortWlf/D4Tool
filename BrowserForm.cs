...
namespace CefSharp.MinimalExample.WinForms
{
    public partial class BrowserForm : Form
    {
...
#endif
        private readonly string title = "D4Tool (" + Build + ")";
        ...
        public BrowserForm()
        {
            ...
            browser = new ChromiumWebBrowser("https://clanlvl.weebly.com/media.html");
        ...
        private void helltidesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var searchUrl1 = "https://helltides.com/";

            browser.LoadUrl(searchUrl1);
        }

        private void interactiveMapToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var searchUrl2 = "https://maxroll.gg/d4/map-tool";

            browser.LoadUrl(searchUrl2);
        }
        ...
        private void clanLVLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var searchUrl0 = "https://clanlvl.weebly.com/media.html";

            browser.LoadUrl(searchUrl0);
        }
    }
}
